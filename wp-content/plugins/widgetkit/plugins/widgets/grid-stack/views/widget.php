...
<?php foreach ($items as $i => $item) :  ?>
    ...
    <div class="<?php echo $grid; ?> uk-text-<?php echo $text_align; ?> <?php echo $content_align; ?>" data-uk-grid-match data-uk-margin="{cls:'uk-margin-top'}">
        ...
        <?php if ($item['media'] && $settings['media'] && !$align_flip) : ?>
        <div class="<?php echo $media_width; ?> uk-text-center<?php if ($settings['animation_media'] != 'none') echo ' uk-invisible'; ?>" <?php echo $animation_media; ?>>
            <?php echo $media; ?>
        </div>
        <?php endif; ?>

        <?php if (($item['title'] && $settings['title']) || ($item['content'] && $settings['content'])) : ?>
        <div class="<?php echo $content_width; ?><?php if ($settings['animation_content'] != 'none') echo ' uk-invisible'; ?>" <?php echo $animation_content; ?>>
