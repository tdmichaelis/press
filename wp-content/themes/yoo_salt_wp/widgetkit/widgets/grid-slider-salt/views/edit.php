    ...
    <div class="uk-width-medium-3-4">
        ...
        <ul id="nav-content" class="uk-switcher">
            <li>
                ...
                <div class="uk-form-row">
                    <label class="uk-form-label" for="wk-panel-5">{{'Panel 5' | trans}}</label>
                    <div class="uk-form-controls">
                        <select id="wk-panel-5" class="uk-form-width-medium" ng-model="widget.data['panel4']">
                            <option value="box">{{'Box' | trans}}</option>
                            <option value="primary">{{'Box Primary' | trans}}</option>
                            <option value="secondary">{{'Box Secondary' | trans}}</option>
                            <option value="space">{{'Space' | trans}}</option>
                ...
                <div class="uk-form-row">
                    <label class="uk-form-label" for="wk-panel-6">{{'Panel 6' | trans}}</label>
                    <div class="uk-form-controls">
                        <select id="wk-panel-6" class="uk-form-width-medium" ng-model="widget.data['panel5']">
                            <option value="box">{{'Box' | trans}}</option>
                            <option value="primary">{{'Box Primary' | trans}}</option>
                            <option value="secondary">{{'Box Secondary' | trans}}</option>
                            <option value="space">{{'Space' | trans}}</option>
