...
class AngularPlugin extends ApplicationAware implements PluginInterface
{
    /**
     * @var array
     */
    ...
    public function boot()
    {
        ...
        $this['scripts']->register('angular-animate', $path.'/assets/angular-animate/angular-animate.min.js', array('angular'));
        $this['scripts']->register('angular-cookies', $path.'/assets/angular-cookies/angular-cookies.min.js', array('angular'));
        $this['scripts']->register('angular-loader', $path.'/assets/angular-loader/angular-loader.min.js', array('angular'));
        $this['scripts']->register('angular-messages', $path.'/assets/angular-messages/angular-messages.min.js', array('angular'));
        $this['scripts']->register('angular-resource', $path.'/assets/angular-resource/angular-resource.min.js', array('angular'));
        $this['scripts']->register('angular-route', $path.'/assets/angular-route/angular-route.min.js', array('angular'));
        $this['scripts']->register('angular-sanitize', $path.'/assets/angular-sanitize/angular-sanitize.min.js', array('angular'));
