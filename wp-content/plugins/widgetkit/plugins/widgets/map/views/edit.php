    ...
    <div class="uk-width-medium-3-4">
        ...
        <ul id="nav-content-map" class="uk-switcher">
            ...
            <li>
                ...
                <div class="uk-form-row">
                    <span class="uk-form-label">{{'Lightness' | trans}}</span>
                    <div class="uk-form-controls uk-form-controls-text">
                ...
                <div class="uk-form-row">
                    <label class="uk-form-label" for="wk-hue-text">{{'Hue' | trans}}</label>
                    <div class="uk-form-controls">
                        <input id="wk-hue-text" class="uk-form-width-small" type="text" ng-model="widget.data['styler_hue']"> ({{'e.g. %example%' | trans: {example:'#ff0000'} }})
                    </div>
                </div>

                <div class="uk-form-row">
                    <label class="uk-form-label" for="wk-saturation-text">{{'Saturation' | trans}}</label>
                    <div class="uk-form-controls">
                        <input id="wk-saturation-text" class="uk-form-width-small" type="text" ng-model="widget.data['styler_saturation']"> ({{'%from% to %to%' | trans: {from:-100, to:100} }})
                    </div>
                </div>

                <div class="uk-form-row">
                    <label class="uk-form-label" for="wk-lightness-text">{{'Lightness' | trans}}</label>
                    <div class="uk-form-controls">
                        <input id="wk-lightness-text" class="uk-form-width-small" type="text" ng-model="widget.data['styler_lightness']"> ({{'%from% to %to%' | trans: {from:-100, to:100} }})
                    </div>
                </div>

                <div class="uk-form-row">
                    <label class="uk-form-label" for="wk-gamma-text">{{'Gamma' | trans}}</label>
                    <div class="uk-form-controls">
                        <input id="wk-gamma-text" class="uk-form-width-small" type="text" ng-model="widget.data['styler_gamma']"> ({{'%from% to %to%' | trans: {from:0, to:10} }})
                    </div>
                </div>
                        ...
                        <p class="uk-form-controls-condensed" ng-if="widget.data.media_align == 'left' || widget.data.media_align == 'right'">
                            <label>
                                <select class="uk-form-width-small" ng-model="widget.data['media_breakpoint']">
                                    ...
                                    <option value="xlarge">{{'Large Screens' | trans}}</option>
                                </select>
                                {{'Breakpoint' | trans}}
                            </label>
                        </p>
