...
<div class="uk-form uk-form-stacked" ng-class="vm.name == 'contentCtrl' ? 'uk-width-large-2-3 wk-width-xlarge-1-2' : ''" ng-controller="woocommerceCtrl as wc">
        ...
        <div>
            ...
            <div class="uk-form-controls">
                <select class="uk-width-1-1" ng-model="content.data['content']">
                    ...
                    <option value="excerpt">{{'Short' | trans}}</option>
                </select>
            </div>
